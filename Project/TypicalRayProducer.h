...
public:
	...
	void SetVolSize(const int volDims[3],const float volSpacings);
	void GetVolSize(int volDims[3], float volSpacings);
...
//	unsigned char * Get_UCImageData(){return m_UC_data;}
