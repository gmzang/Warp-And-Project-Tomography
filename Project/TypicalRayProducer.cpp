...
//TypicalRayProducer::TypicalRayProducer(int vX,int vY,int vZ,int imgW, int imgH,double ds, double offx,double offy, const char * _bp)
TypicalRayProducer::TypicalRayProducer(int vX, int vY, int vZ, int imgW, int imgH, double ds,  const char * _bp)
{
	...
	m_ImageData=0;
	m_WeightOfImage=0;
	//m_EachVoxel_TotalWeight=0;
	//m_Voxel_Contributions=0;
...
void TypicalRayProducer::SetVolSize(const int volDims[3],const float volSpacings)
{
	...
	Vol_Y = volDims[1];
	Vol_Z = volDims[2];
	m_VolSpacings[0]= volSpacings;
	m_VolSpacings[1]= volSpacings;
	m_VolSpacings[2]= volSpacings;

	m_VolSize[0]=(volDims[0]-1)*volSpacings;
	m_VolSize[1]=(volDims[1]-1)*volSpacings;
	m_VolSize[2]=(volDims[2]-1)*volSpacings;


}

void TypicalRayProducer::GetVolSize(int volDims[3],float volSpacings)
{
	volDims[0]=m_VolDims[0];
	volDims[1]=m_VolDims[1];
	volDims[2]=m_VolDims[2];

	volSpacings= volSpacings;
	/*volSpacings[1]= volSpacings;
	volSpacings[2]= volSpacings;*/
}
