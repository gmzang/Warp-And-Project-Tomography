...
void Scene::_calculateCamera()
{
	...
	GetSize3D(size);
		...
		//cout << "Test the m_Translate 22" << m_Translate[0] << " " << m_Translate[1] << " " << m_Translate[2] << endl;
...
void Scene::SetSize3DModified()
{
	...
	// Rose  Y same, Z oppsite.  -11.1644838684374f and  -2.07001068685314f used
	// Dough Y oppsite, Z opposite 6.38405943477408 and   2.62873035549521 used
	...
	//cout << "Test the m_Translate " << m_Translate[0] << " " << m_Translate[1] << " " << m_Translate[2] << endl;
	// dough
	//m_Translate[1] = 6.38405943477408f; // 20.9767737621844f 12.1218347737581f 
	//									 ////m_Translate[0]=0.0f;
...
void Scene::RenderContent( int  iframe, bool isWarped, int ProIdx)
{
